...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var formValidation = new _FormValidation2.default(_RuleLib2.default);
	var MyValidation = {};

	//注册新规则
	MyValidation.registerRule = function (name, validation, msg) {
	    formValidation.registerRule(new _Rule2.default(name, validation, msg));
	};
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @constructor
	 */
	exports.default = [required, max, min, maxSize, minSize, number, integer];
